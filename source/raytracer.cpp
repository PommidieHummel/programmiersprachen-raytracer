...
int main(int argc, char* argv[])
{
  ...
  Sphere s2{{"kreise"},{materia},{-20,10,-100},20};
  Box b{{"box"},materia,{-100,-80,-300},{10,10,-200}};
  Light l{{"Sun"},{500,700,0},{0.2f,0.2f,0.2f},1};
  Light la{{"Moon"},{1000,-70,0},{0.2f,0.1f,0.2f},1};
